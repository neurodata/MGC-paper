...
for i=1:rep1;
    ...
    [p(1),p(2),p(3),p(4),p(5),p(6),p(7)]=CorrPermDistTest(distC,distPInd,rep1,rep2,'BrainCxPInd');
    for j=1:7
        if p(j)<alpha
...
[power1,power2,power3]=CorrPermDistTest(distM2g(ind,ind),distMigrain(ind,ind),rep1,rep2,'M2gxMigrain');
