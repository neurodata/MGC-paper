...
% Previous approaches have struggled to reliably identify relationships when the properties are complex and high-dimensional and the relationship is nonlinear. 
% @bm: not sure which of the above is better
...
% Our key insight was a how to design a procedure, \Mgc, that can estimate the optimal scales yielding a statistically consistent and computationally efficient test. \Mgc~is therefore able to (i) statistically dominates global methods---we prove that it is always as good as global methods in linear settings, and can be better in nonlinear settings---and, (ii) uniquely provide insight into the nature of dependencies it detects. 
