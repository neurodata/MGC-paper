function [power1, power2, power3, power4]=CorrIndTest(type,n,dim,lim,rep)
...
for r=1:rep
    ...
    for i=1:lim
        ...
        dCor2A(r,1:nn-1,i)=rankDCorr(C,P);
...
for r=1:rep
    ...
    for i=1:lim
        ...
        dCor2N(r,1:nn-1,i)=rankDCorr(C,P);
...
save(filename,'power1','power2','power3','power4','type','n','numRange','rep','lim','dim','dCor1N','dCor2N','dCor3N','dCor4N','dCor1A','dCor2A','dCor3A','dCor4A');
...
if display~=0
    ...
    legend('Distance Correlation','Ranking Distance Correlation','Modified Distance Correlation','HHG','Location','SouthEast');
