...
txt1 = ['Mcorr'];
txt2 = ['MGC'];
a=text(x1,y1,'Mcorr','VerticalAlignment','bottom','HorizontalAlignment','left');
b=text(x2,y2,'MGC','VerticalAlignment','bottom','HorizontalAlignment','left');
set(a,'FontSize',17);
set(b,'FontSize',17);
x1 = tA(end);
x2 = tA(k,l);
y2 = 2;
a=text(x1,y2,['p = ' num2str(1-pAll(end))],'VerticalAlignment','bottom','HorizontalAlignment','left');
b=text(x2,y2,'p < 0.001','VerticalAlignment','bottom','HorizontalAlignment','left');
set(a,'FontSize',17);
set(b,'FontSize',17);
xlim([minp,maxp]);
