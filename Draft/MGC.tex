...
\newtheorem{appThm}{Theorem}{0}
\newtheorem{lem}{Lemma}
\newtheorem{appLem}{Lemma}{0}
...
Therefore the p-value of $\G^{kl}$ cannot be less than the p-value of $\G$ under linear dependency, in which case the global correlation is the optimal scale for \Mgc. \cs{connect permutation and p-values.}
\end{proof}
