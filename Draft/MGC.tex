...
\begin{tabular}{c  c  c  c}
 $\delta_x$(1,2) & \hspace{1.8em} -1.45 \hspace{1.8em}  & \hspace{1.8em} -2.08 \hspace{1.8em} & \hspace{1.8em} -2.08 \hspace{1.8em}  \\ 
 $\delta_y$(1,2) & 0.83 & 1.43 & 0.00  \\ 
 $\delta_x \times \delta_y$ & -1.20 & -1.45 & 0.00  \\ 
 
\hline


 $\delta_x$(2,3) & -1.90 & -2.70 & -2.70  \\ 
 $\delta_y$(2,3) & -2.05 & -2.60 & -2.60  \\ 
...
define random permutation and the notatio n $B(\pi,\pi)$ for this audience, not sure where that should go, probably in caption.}
\label{alg:pval}
\begin{algorithmic}[1]
