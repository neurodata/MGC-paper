...
Discovering whether certain properties are associated with other properties is a fundamental endeavor. Questions about the nature of relationships date back to antiquity, and permeate modern investigations ranging from medicine to public policy to finance, and of course, all of science.
...
% 
Note that for all simulations, there always exists a large smooth region of local scales that are nearly equally significant in the power map, which is an important observation that we use to approximate the optimal scales of sample \Mgc~by smooth regions in the p-value map.
