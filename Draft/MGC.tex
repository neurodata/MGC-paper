...
Each panel shows power at significance level $\alpha=0.05$
...
Each panel shows power on the abscissa at a significance level $\alpha=0.05$, and sample size on the ordinate.
