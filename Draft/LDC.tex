...
Section~\ref{appen:eval} shows how the three core algorithms are combined to yield the testing powers of MGC in the simulations and the p-values of MGC in the real data experiment.
