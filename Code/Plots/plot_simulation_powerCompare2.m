...
for select=0:1
    ...
    labels={1,5,10,15, 'Average'};
    set(gca,'XTick',[1,5,10,15,21],'XTickLabel',labels,'FontSize',fontSize);
    ...
    h=legend([h5,h1 h2 h3 h4],string(txt5{1}),string(txt1{1}),string(txt2{1}),string(txt3{1}),string(txt4{1}),'Location','EastOutside','FontSize',fontSize+3);
