...
n=114;rep1=4;rep2=3000;alpha=0.05;
...
option=[1,2,3,4];
CorrPermDistTest(LMLS,y,rep1,rep2,'BrainLMLxY',option,per);
CorrPermDistTest(LMRS,y,rep1,rep2, 'BrainLMRxY',option,per);
