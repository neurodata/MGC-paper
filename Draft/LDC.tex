...
\jv{these guys also lower right is (1,1)}
}
\label{figSim3}
\end{figure}
...
\jv{please comment about the downside of this approach.  in particular, the resampled matrices may not actually be distance matrices.}
