...
\new{Existing approaches can provide a consistent p-value, but cannot provide insight into the geometry underlying the structure of the relationship. }
...
\new{Moreover, we demonstrate that \Mgc~also reveals the latent structure underlying the relationship without requiring any additional samples or analyses.}
...
% new mention of the nature of relationship here?

% below paragraph should be broken into 2 perhaps, one about power, the other about geometry
