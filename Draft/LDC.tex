...
\end{align*}
\jv{why no ``w'' above?}
\cs{This, joint normal, and multiplicative noise has no w. Because they are already difficult without w; they are also directly the same as the original simulations from other people; and it will be nice to have a few cases where $d_{x}=d_{y}$ if we can.}
\cs{}
