...
\label{numer3}
Here we apply local correlations and \Mgc~to visualize the relationship and test independence between real data sets. Since there is no known model for the given data, the optimal scale for \Mgc~is approximated based on the p-values of all local correlations from the permutation test (see Appendix \ref{appen:tests} for details and further discussions). 
