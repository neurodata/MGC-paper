...
Our key insight is that if the two different modalities are dependent, then local distances within one modality (images) should correlate with local distances within the other modality (text).  
