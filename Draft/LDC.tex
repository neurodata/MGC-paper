...
\begin{figure}
  ...
  \end{tabular}
  \caption{\Mgc~is robust against outliers. We simulated $n=100$ data points  according to  Equation \eqref{e:outlier} with 70\%, 50\%, and 30\%  outliers (depicted across the three columns).
...
\jv{the paragraph below seems more appropriate at intro than conclusion?}
