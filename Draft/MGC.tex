...
Column 1: $(X,Y)$ are nonlinearly dependent on one another, with each pair $(\mbx_i,\mby_i)$ having a spiral relationship.
...
Column 5: Top shows the empirical null distribution for the modified distance correlation, \Mcorr \cite{SzekelyRizzo2013a}, as well as our newly defined \Mgc, and the corresponding observed test statistic. The global correlation has a p-value of $0.188$ while \Mgc~has a p-value $<0.001$.
