...
title(strcat(tits{6},'.',{' '},'False Positive Rate'),'FontSize',fs, ...
    'Units', 'normalized','Position', [0 1.05], 'HorizontalAlignment', 'left')
...
title(strcat(tits{5},'.',{' '},'P-value Scatter Plot'),'FontSize',fs, ...
    'Units', 'normalized','Position', [0 1.05], 'HorizontalAlignment', 'left');
axis('square');
% semilogy(pMGC(ind));
...
title(strcat(tits{3},'.',{' '},'Entrywise Distance Products'),'FontSize',fs, ...
    'Units', 'normalized','Position', [0 1.05], 'HorizontalAlignment', 'left');
axis('square');
