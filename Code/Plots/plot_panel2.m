...
ylim([min(D2), max(D2)]);
warning('off','all')
xlabel('Distance$$_{x}(x_i,x_j)$$','FontSize',F.fontSize2+3,...
    'Units', 'normalized','Position', [-0.01, -0.08], 'HorizontalAlignment', 'left','Interpreter','latex');
ylabel('Distance$$_{y}(y_i,y_j)$$','FontSize',F.fontSize2+3, ...
