...
Figure \ref{f:schematic} schematically illustrates our method on a particular nonlinear dependence structure.
...
% Specifically, 
We are interested in assessing the performance of our newly proposed multiscale tests in a comprehensive set of simulations, to better understand which the tests, and gain insight into which to use in different settings.  
...
We therefore consider $20$ different joint distributions $f_{xy}$. A large fraction of these are taken exactly from existing literature \cite{SzekelyRizzoBakirov2007, SimonTibshirani2012, GorfineHellerHeller2012, HellerGorfine2013}, and we have added several additional settings.  They include:
